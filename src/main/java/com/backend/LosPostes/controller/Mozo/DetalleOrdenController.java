...
public class DetalleOrdenController {
    ...
    @GetMapping(path="/listar/{ordenId}")
    public ResponseEntity<Object> getDetalleOrdenes(@PathVariable("ordenId") Integer id) {
        return JSendResponse.success(detalleOrdenService.getDetalleOrden(id));
    }
