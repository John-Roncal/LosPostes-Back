...
public class JwtService {
    private static final String SECRET_KEY = "WQ6JD9ohMSbQx1GNzOKZYlVzRufuNtwJXrHitECsFtN1anDsAgNKPXwFxlkLWoYv"; //No es recomendable colocarla en código, en producción hay herramientas que gestionan estas Secret Key
